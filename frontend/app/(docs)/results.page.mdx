export const metadata = {
  title: 'Agentic Information-Edge Results',
  description: 'Simulation results: how trader heterogeneity, capital, and correlation shape price discovery in event-triggered prediction markets. 2,400 simulated markets across six agent populations and four information regimes.',
}
...
Total dataset: 2,400 runs × four record types (summary, agent-level, snapshot, trade-level) ≈ 850K rows across four parquet files, 17 MB on disk, joined by `run_id`.
...
![Marginal Informational Contribution](/figures/02_metric_1_marginal_contribution.png)
...
![Brier Heatmap by Mix × Regime](/figures/01_brier_heatmap.png)
...
![Tail-Regime Final Price vs Truth](/figures/04_metric_3_tail_regime.png)
...
![Correlation Regime Impact](/figures/05_metric_4_correlation.png)
...
![Brier Convergence Trajectories](/figures/03_convergence_trajectories.png)
